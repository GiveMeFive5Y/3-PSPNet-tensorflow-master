...
cityscapes_param = {'crop_size': [720, 720],
                    ...
                    'num_steps': 500,
                    'model': PSPNet101,
                    'data_dir': '/media/workstation/68bf06e9-e6f8-4333-ae81-6bf0b33b7742/workstation/anaconda3/A-code/3-PSPNet-tensorflow-master/data-15', #### Change this line
...
def main():
    ...
    if args.dataset == 'ade20k':
        ...
        mIoU, update_op = tf.contrib.metrics.streaming_mean_iou(pred, gt/255, num_classes=num_classes+1)
    elif args.dataset == 'cityscapes':
        mIoU, update_op = tf.contrib.metrics.streaming_mean_iou(pred, gt/255, num_classes=num_classes)
